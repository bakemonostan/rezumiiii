<template>
  <div class="bg-white px-12">
    <div class="flex flex-row justify-between py-4 px-3">
      <h3 class="font-black text-3xl">Create Job</h3>
    ...
    <div class="px-12 mt-16">
      <FormKit
        ...
        :value="{
          tittle: 'Senior Frontend Dev',
          description:
            'Senior Role: we are looking for a experienced dedicated team player',
          benefit: 'Vacations',
          jobType: 2,
          department: 'IT',
...
const send = (values) => {
  ...
  const {
    ...
    data: reffer,
    error,
  } = useFetch("/api/JobManager/create-job", {
    method: "POST",
